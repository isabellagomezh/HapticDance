...
class Piece1ViewController: UIViewController {
    ...
    @IBAction func setDancer(_ sender: UISegmentedControl) {
    ...
    @IBAction func playPiece1AHAP(_ sender: UIButton) {
        let file = "AHAP/Choreos/thillana_p" + dancer
        print(file)
